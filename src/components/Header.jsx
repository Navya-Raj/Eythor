  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8 flex items-center justify-center" href="#hero">
          <img src={eythor} width={50} height={50} alt="Eythor" />
          <h2 className="font-bold text-[28px] text-n-6">Eythor</h2>
        </a>
