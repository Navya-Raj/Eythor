import { curve, heroBackground, robot, solar } from "../assets";
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-4 lg:mb-8 text-n-7">
        ...
        <div className="relative max-w-[30rem] mx-auto md:max-w-7xl xl:mb-24 mt-[-30rem] z-0 opacity-100">
