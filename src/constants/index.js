...
export const benefits = [
  ...
  {
    id: "4",
    title: "Panel temperature sensing",
    text: "Monitor and optimize panel efficiency with real-time temperature tracking.",
  ...
  {
    id: "5",
    title: "Dust sensing on solar panels",
    text: "Ensure peak performance by detecting and responding to dust accumulation automatically.",
