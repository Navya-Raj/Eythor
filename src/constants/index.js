...
export const benefits = [
  {
    ...
    text: "Control web apps via mobile. Set automatic cleaning times and modes with ease, enhancing user convenience and efficiency.",
  ...
  },
  {
    ...
    text: "Offers independent control, grouping, and automatic cleaning features, leveraging IoT technology for smarter, more efficient operations.",
  ...
  },
  {
    ...
    text: "Equipped with a self-charging solar power system for convenience and efficiency, ensuring operation lasts between 8-10 hours.",
  ...
  },
  {
    ...
    text: "Designed for compatibility with various arrangement arrays and power stations, offering strong adaptability across different setups.",
  ...
  },
  {
    ...
    text: "Monitor and optimize panel efficiency with real-time temperature tracking, ensuring optimal performance under various conditions.",
  ...
  },
  {
    id: "5",
    title: "Dust sensing",
    text: "Automatically detects and responds to dust accumulation on solar panels, ensuring peak performance and longevity of the system.",
